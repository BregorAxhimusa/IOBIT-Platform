      ...
      <div className="relative bg-[#0f1419] border border-gray-800 w-full max-w-md animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="p-6">
          ...
          <div className="flex flex-col items-center mb-6">
            <div className="w-14 h-14 bg-gradient-to-br from-amber-500 to-orange-500 flex items-center justify-center mb-4 shadow-lg shadow-amber-500/20">
              <svg className="w-7 h-7 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z" />
              </svg>
            </div>
            <h2 className="text-xl font-bold text-white">Add API Wallet</h2>
          ...
          <div className="mb-4">
            <label className="text-xs text-gray-500 font-medium mb-2 block">Wallet Address</label>
            <input
              type="text"
              value={address}
              onChange={(e) => setAddress(e.target.value)}
              placeholder="0x..."
              className="w-full bg-[#1a2028] border border-gray-800 px-4 py-3 text-white text-sm font-mono focus:outline-none focus:border-teal-500/50 placeholder-gray-600"
            />
            {address && !isValidAddress && (
              <div className="flex items-center gap-1.5 mt-2 text-red-400">
                ...
                <span className="text-xs">Invalid Ethereum address</span>
              </div>
            )}
            {address && isValidAddress && (

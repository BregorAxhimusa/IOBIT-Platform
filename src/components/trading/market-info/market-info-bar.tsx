      ...
      <div className="w-full px-3 sm:px-4 md:px-6">
        <div className="flex items-center justify-between h-14 sm:h-14 md:h-14">
          ...
          <div className="flex items-stretch space-x-2 sm:space-x-4 md:space-x-6 lg:space-x-8 overflow-x-auto scrollbar-hide">
            ...
            {/* Price Display */}
            <div className="flex flex-col justify-center border-l border-gray-700/60 pl-3 sm:pl-4 md:pl-6 lg:pl-8 py-3 md:py-4 flex-shrink-0">
            ...
            <div className="hidden sm:flex flex-col justify-center border-l border-gray-700/60 pl-4 md:pl-6 lg:pl-8 py-3 md:py-4 flex-shrink-0">
            ...
            <div className="hidden md:flex flex-col justify-center border-l border-gray-700/60 pl-6 lg:pl-8 py-4 flex-shrink-0">
            ...
            {/* Open Interest - Hidden on mobile and tablet */}
            <div className="hidden lg:flex flex-col justify-center border-l border-r border-gray-700/60 pl-8 pr-8 py-4 flex-shrink-0">
              <span className="text-[11px] font-medium text-gray-500 uppercase tracking-wide mb-1">
                Open Interest
              </span>
              <span className="text-base font-bold text-gray-200 tracking-tight whitespace-nowrap">

      ...
      <div className="space-y-3">
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="px-3 py-1.5 text-xs font-medium bg-teal-500/10 text-teal-400 rounded-lg hover:bg-teal-500/20 transition-colors"
          >
            Transfer to Staking
          </button>
        </div>
        ...
        {showDeposit && (
          <div className="bg-[#1a2028] rounded-lg p-3 space-y-2">
            <div className="flex gap-2">
              <input
                ...
                placeholder="Amount"
                className="flex-1 bg-[#0f1419] border border-gray-700 rounded-lg px-3 py-2 text-white text-sm focus:outline-none focus:border-gray-500"
              />
              <button
            ...
            <button
              ...
              className="w-full py-2 rounded-lg text-xs font-semibold bg-teal-500 hover:bg-teal-500/80 text-white disabled:bg-teal-500/30 disabled:text-white/50 transition-colors"
            >
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="px-3 py-1.5 text-xs font-medium bg-amber-500/10 text-amber-400 rounded-lg hover:bg-amber-500/20 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Withdraw to Spot
          </button>
        </div>
        ...
        {showWithdraw && (
          <div className="bg-[#1a2028] rounded-lg p-3 space-y-2">
            ...
            <button
              ...
              className="w-full py-2 rounded-lg text-xs font-semibold bg-amber-500 hover:bg-amber-500/80 text-white disabled:bg-amber-500/30 disabled:text-white/50 transition-colors"
            >
